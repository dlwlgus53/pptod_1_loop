...
class DSTMultiWozData:
    def __init__(self, save_path, model_name, tokenizer, train_path, dev_path, test_path, shuffle_mode='shuffle_session_level', 
        data_mode='train', add_prefix=True, add_special_decoder_token=True, train_data_ratio=1.0, use_list_path = None, short = 0):
        '''
    ...
    def make_label_key(self, dial_id, turn_id):
    ...
    def add_sepcial_tokens(self):
        """
            ...
            serves a silar role of Vocab.construt()
